                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                if (mEditTextEmail.getText().toString().equals("admin@gmail.com")) {
                                    ...
                                    System.out.println(fireUser.getUid());
                                    UsuarioController.crearUsuario(usuario, fireUser.getUid());
                                    Intent i = new Intent(RegisterActivity.this, NavigationUserActivity.class);
                                    startActivity(i);
                                    finish();
                                }
                            }
                            else{
                                Toast.makeText(RegisterActivity.this,"Usuario o contraseña incorrectos. Inténtelo nuevamente",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
